...
const SettingsDropDownInCardFocused = ({ id, setCurrentLabel , setBackgroundColor ,backgroundColorFromDb , setCardBackgroundColor }) => {
    return (
        <div>
            <div className=' z-50'>
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className=" z-50 bg-neutral-700 rounded-xl border-none drop-shadow-xl shadow-neutral-600">
                        <DropdownMenuItem ><ColorPicker setCardBackgroundColor={setCardBackgroundColor} backgroundColorFromDb={backgroundColorFromDb} setBackgroundColor={setBackgroundColor} /></DropdownMenuItem>
                        <DropdownMenuSeparator />
