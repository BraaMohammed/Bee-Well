...
const Sidebar = ({ refreshFunction }) => {
    ...
    return (
        ...
        <div className=" hidden bg-neutral-600 lg:flex flex-col w-[15vw] max-h-full h-screen fixed left-0 top-0 gap-0 justify-between p-6 pt-1 ">
            ...
            <p onClick={() => { router.push("/") }} className="flex gap-2 p-2 rounded-xl  hover:bg-neutral-950 ease-in-out duration-200 text-sm " ><NotebookText size={23} />My Notes</p>
            ...
            <p onClick={() => { router.push("/journal") }} className="flex gap-2 p-2 rounded-xl  hover:bg-neutral-950 ease-in-out duration-200 text-sm " ><NotebookPen size={24} />Journal</p>
